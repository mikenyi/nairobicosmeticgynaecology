		...
		<div className='perineoplasty__main'>
			...
			{showMore?
				<div className="perineoplasty__showMoreContainer">
					<button className="perineoplasty__showMore" onClick={ handleShowMore }>SHOW MORE...  <i className="fa fa-caret-down"></i>
			      	</button>
					<h4>!!!Viewer discretion is advised</h4>
				</div>
				:<div className='perineoplasty__moreInfoContainer' onClick={ handleShowMore }>
					<button className="perineoplasty__showLess" onClick={ handleShowMore }>SHOW LESS...  <i className="fa fa-caret-up"></i>
			      	</button>
			...
			{showFaq?
				<div className="perineoplasty__showFaqContainer">
					<button className='perineoplasty__showFaq' onClick={ handleShowFaq }>SHOW FAQs... <i className="fa fa-caret-down"></i></button>
				</div>
				:<div className="perineoplasty__faqConatianer" onClick={ handleShowFaq } >
					<button className='perineoplasty__hideFaq' onClick={ handleShowFaq }>HIDE FAQs... <i className="fa fa-caret-up"></i></button>
