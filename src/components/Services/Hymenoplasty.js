			...
			<div className="hymenoplasty__mainContainer">
				...
				{showLess?
					<div className="hymenoplasty__showMoreContainer">
						<button className="hymenoplasty__showLess" onClick={ handleShowLess }>SHOW MORE...  <i className="fa fa-caret-down"></i>
						</button>
						<h4>!!!Viewer discretion is advised</h4>
					</div>
					:<div className='hymenoplasty__moreInfoContainer' onClick={ handleShowLess }>
						<button className="hymenoplasty__showLess" onClick={ handleShowLess }>SHOW LESS...  <i className="fa fa-caret-up"></i>
						</button>
				...
				{hideFaq?
					<div className="hymenoplasty__hideFaqContainer">
						<button className='hymenoplasty__hideFaq' onClick={ handleHideFaq }>SHOW FAQs... <i className="fa fa-caret-down"></i></button>
					</div>
					:<div className="hymenoplasty__faqConatianer" onClick={ handleHideFaq } >
						<button className='hymenoplasty__hideFaq' onClick={ handleHideFaq }>HIDE FAQs... <i className="fa fa-caret-up"></i></button>
